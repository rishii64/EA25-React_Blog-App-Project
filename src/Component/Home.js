        ...
        <div>
          <div className='left section2'>
              ...
              <div className='info articles'>
                ...
                <p className='des'>{blogData[0][5].desc.slice(0,350)}....</p>
                <p className='ref'>Bollywood : 17-10-23</p>
              </div>
          </div>
          <div className='left section2'>
              ...
              <div className='info articles'>
                ...
                <p className='des'>{blogData[0][16].desc.slice(0,350)}....</p>
          ...
          <div className='left section2'>
              ...
              <div className='info articles'>
                <h3><Link to={`/Blog/${blogData[0][22].id}`}>{blogData[0][22].title}</Link></h3>
                <p className='des'>{blogData[0][22].desc.slice(0,350)}....</p>
      ...
      <div className='theLatest'>
          ...
          <div className='left section1'>
              ...
              <div className='info home'>
                ...
                <p className='des'>{blogData[0][24].desc.slice(0,240)}....</p>
                <p className='ref'>Bollywood : 17-10-23</p>
              </div>
          </div>
          <div className='left section1'>
